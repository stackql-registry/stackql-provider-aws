...
export async function flattenAllOf(apiDoc: any): Promise<any> {
  ...
  async function processAllOf(schema: any): Promise<any> {
    ...
    if (schema.allOf && Array.isArray(schema.allOf)) {
      ...
      const processed = await Promise.all(schema.allOf.map((s: any) => processAllOf(s)));
 ...
 * @private
 */
async function resolveRef(obj: any, api: any, visitedRefs = new Set()): Promise<any> {
  if (obj && obj.$ref) {
