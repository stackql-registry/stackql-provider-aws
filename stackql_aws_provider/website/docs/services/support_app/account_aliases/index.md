...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.support_app.account_aliases" /></td></tr>
</tbody></table>
...
SELECT
account_alias
FROM aws.support_app.account_aliases
...
```sql
REPLACE aws.support_app.account_aliases
SET 
...
```sql
DELETE FROM aws.support_app.account_aliases
WHERE region = '{{ region }}' --required
;
```
</TabItem>
