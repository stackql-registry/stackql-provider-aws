...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.docdb.source_identifier_from_subscriptions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Removes a source identifier from an existing Amazon DocumentDB event notification subscription.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-SourceIdentifier">
    ...
    <td>The source identifier to be removed from the subscription, such as the instance identifier for an instance, or the name of a security group.</td>
</tr>
<tr id="parameter-SubscriptionName">
    <td><CopyableCode code="SubscriptionName" /></td>
    <td><code>string</code></td>
    <td>The name of the Amazon DocumentDB event notification subscription that you want to remove a source identifier from.</td>
</tr>
...
```sql
UPDATE aws.docdb.source_identifier_from_subscriptions
SET 
