--- 
title: network_migration_code_generations
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>network_migration_code_generations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="network_migration_code_generations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.mgn.network_migration_code_generations" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_network_migration_code_generations"
    values={[
        { label: 'list_network_migration_code_generations', value: 'list_network_migration_code_generations' }
    ]}
>
<TabItem value="list_network_migration_code_generations">
...
<tbody>
<tr>
    <td><a href="#list_network_migration_code_generations"><CopyableCode code="list_network_migration_code_generations" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Lists network migration code generation jobs, which convert network mappings into infrastructure-as-code templates.</td>
</tr>
</tbody>
</table>
