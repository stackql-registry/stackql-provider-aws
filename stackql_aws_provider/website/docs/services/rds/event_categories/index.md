...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.rds.event_categories" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The event categories for the specified source type</td>
</tr>
<tr>
    <td><CopyableCode code="SourceType" /></td>
    <td><code>string</code></td>
    <td>The source type that the returned categories belong to</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-SourceType"><code>SourceType</code></a>, <a href="#parameter-Filters"><code>Filters</code></a></td>
    <td>Displays a list of categories for all event source types, or, if specified, for a specified source type. You can also see this list in the "Amazon RDS event categories and event messages" section of the Amazon RDS User Guide or the Amazon Aurora User Guide .</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-SourceType">
    <td><CopyableCode code="SourceType" /></td>
    <td><code>string</code></td>
    <td>The type of source that is generating the events. For RDS Proxy events, specify db-proxy. Valid Values: db-instance | db-cluster | db-parameter-group | db-security-group | db-snapshot | db-cluster-snapshot | db-proxy</td>
</tr>
</tbody>
</table>
