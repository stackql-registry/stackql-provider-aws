...
<tr>
    ...
    <td>Creates a new DB subnet group. DB subnet groups must contain at least one subnet in at least two AZs in the Amazon Web Services Region.</td>
</tr>
<tr>
    ...
    <td>Modifies an existing DB subnet group. DB subnet groups must contain at least one subnet in at least two AZs in the Amazon Web Services Region.</td>
</tr>
<tr>
...
<tr id="parameter-DBSubnetGroupName">
    ...
    <td><code>string</code></td>
    <td>The name of the database subnet group to delete. You can't delete the default subnet group. Constraints: Must match the name of an existing DBSubnetGroup. Must not be default. Example: mydbsubnetgroup</td>
</tr>
...
<tr id="parameter-Tags">
    ...
    <td><code>array</code></td>
    <td>Tags to assign to the DB subnet group.</td>
</tr>
</tbody>
</table>
