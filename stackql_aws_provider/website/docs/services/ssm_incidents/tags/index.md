...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.ssm_incidents.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>A list of tags for the response plan or incident.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Lists the tags that are attached to the specified response plan or incident.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds a tag to a response plan.</td>
</tr>
<tr>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the response plan you're removing a tag from.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>The name of the tag to remove from the response plan.</td>
</tr>
</tbody>
</table>
