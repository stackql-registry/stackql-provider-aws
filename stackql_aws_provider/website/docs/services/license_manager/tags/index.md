...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.license_manager.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Lists the tags for the specified resource. For more information about tagging support in License Manager, see the TagResource operation.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Adds the specified tags to the specified resource. The following resources support tagging in License Manager: Licenses Grants License configurations Report generators</td>
</tr>
</tbody>
</table>
...
```sql
UPDATE aws.license_manager.tags
SET 
