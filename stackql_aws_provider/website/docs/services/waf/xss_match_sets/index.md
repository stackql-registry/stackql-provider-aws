...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.waf.xss_match_sets" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO aws.waf.xss_match_sets (
Name,
ChangeToken,
region
)
...
```sql
DELETE FROM aws.waf.xss_match_sets
WHERE region = '{{ region }}' --required
;
```
</TabItem>
