...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.waf.permission_policies" /></td></tr>
</tbody></table>
...
SELECT
Policy
FROM aws.waf.permission_policies
...
```sql
REPLACE aws.waf.permission_policies
SET 
...
```sql
DELETE FROM aws.waf.permission_policies
WHERE region = '{{ region }}' --required
;
```
</TabItem>
