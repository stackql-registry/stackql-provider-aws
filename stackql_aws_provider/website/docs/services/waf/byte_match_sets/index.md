...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.waf.byte_match_sets" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO aws.waf.byte_match_sets (
Name,
ChangeToken,
region
)
...
```sql
UPDATE aws.waf.byte_match_sets
SET 
...
```sql
DELETE FROM aws.waf.byte_match_sets
WHERE region = '{{ region }}' --required
;
```
</TabItem>
