...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.waf.rate_based_rules" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="name" /></td>
    <td><code>string</code></td>
    <td>A friendly name or description of the Rule. You can't change the name of a Rule after you create it. (pattern: &lt;code&gt;.*\S.*&lt;/code&gt;)</td>
</tr>
<tr>
    <td><CopyableCode code="rule_id" /></td>
    <td><code>string</code></td>
...
<tr>
    ...
    <td><a href="#parameter-region"><code>region</code></a>, <a href="#parameter-MetricName"><code>MetricName</code></a>, <a href="#parameter-RateKey"><code>RateKey</code></a>, <a href="#parameter-RateLimit"><code>RateLimit</code></a>, <a href="#parameter-ChangeToken"><code>ChangeToken</code></a></td>
    <td></td>
...
```sql
INSERT INTO aws.waf.rate_based_rules (
Name,
MetricName,
RateKey,
RateLimit,
...
```sql
UPDATE aws.waf.rate_based_rules
SET 
RuleId = '{{ RuleId }}',
...
```sql
DELETE FROM aws.waf.rate_based_rules
WHERE region = '{{ region }}' --required
;
```
</TabItem>
