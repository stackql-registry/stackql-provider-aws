...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.waf.logging_configurations" /></td></tr>
</tbody></table>
...
redacted_fields,
resource_arn
FROM aws.waf.logging_configurations
...
```sql
REPLACE aws.waf.logging_configurations
SET 
...
```sql
DELETE FROM aws.waf.logging_configurations
WHERE region = '{{ region }}' --required
;
```
</TabItem>
