--- 
title: recommended_policies_v2
hide_title: false
hide_table_of_contents: false
keywords:
  - recommended_policies_v2
  - securityhub
  - aws
...
Creates, updates, deletes, gets or lists a <code>recommended_policies_v2</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="recommended_policies_v2" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.securityhub.recommended_policies_v2" /></td></tr>
</tbody></table>
...
<tr>
    <td><a href="#generate_recommended_policy_v2"><CopyableCode code="generate_recommended_policy_v2" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-metadata_uid"><code>metadata_uid</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Begins the recommended policy generation to remediate a Security Hub finding. GenerateRecommendedPolicyV2 only supports findings for unused permissions.</td>
</tr>
</tbody>
</table>
...
SELECT
unused_permissions
FROM aws.securityhub.recommended_policies_v2
...
<Tabs
    defaultValue="generate_recommended_policy_v2"
    values={[
        { label: 'generate_recommended_policy_v2', value: 'generate_recommended_policy_v2' }
    ]}
>
<TabItem value="generate_recommended_policy_v2">
...
```sql
EXEC aws.securityhub.recommended_policies_v2.generate_recommended_policy_v2 
@metadata_uid='{{ metadata_uid }}' --required, 
