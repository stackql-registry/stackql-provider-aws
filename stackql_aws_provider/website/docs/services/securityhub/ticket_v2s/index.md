...
Creates, updates, deletes, gets or lists a <code>ticket_v2s</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="ticket_v2s" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.securityhub.ticket_v2s" /></td></tr>
</tbody></table>
...
- name: ticket_v2s
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the ticket_v2s resource.
    - name: ConnectorId
      value: "{{ ConnectorId }}"
