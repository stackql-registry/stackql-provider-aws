...
Creates, updates, deletes, gets or lists a <code>connectors_v2</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="connectors_v2" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.securityhub.connectors_v2" /></td></tr>
</tbody></table>
...
name,
provider_detail
FROM aws.securityhub.connectors_v2
...
```sql
INSERT INTO aws.securityhub.connectors_v2 (
AuthCode,
AuthState,
region
)
...
- name: connectors_v2
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the connectors_v2 resource.
    - name: AuthCode
      value: "{{ AuthCode }}"
    - name: AuthState
      value: "{{ AuthState }}"
...
```sql
UPDATE aws.securityhub.connectors_v2
SET 
...
```sql
DELETE FROM aws.securityhub.connectors_v2
WHERE connector_id = '{{ connector_id }}' --required
AND region = '{{ region }}' --required
;
```
