...
Creates, updates, deletes, gets or lists an <code>automation_rules_v2</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="automation_rules_v2" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.securityhub.automation_rules_v2" /></td></tr>
</tbody></table>
...
rule_status,
updated_at
FROM aws.securityhub.automation_rules_v2
...
```sql
INSERT INTO aws.securityhub.automation_rules_v2 (
RuleName,
RuleStatus,
Description,
RuleOrder,
...
- name: automation_rules_v2
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the automation_rules_v2 resource.
    - name: RuleName
      value: "{{ RuleName }}"
    - name: RuleStatus
      value: "{{ RuleStatus }}"
...
```sql
UPDATE aws.securityhub.automation_rules_v2
SET 
...
```sql
DELETE FROM aws.securityhub.automation_rules_v2
WHERE identifier = '{{ identifier }}' --required
AND region = '{{ region }}' --required
;
```
