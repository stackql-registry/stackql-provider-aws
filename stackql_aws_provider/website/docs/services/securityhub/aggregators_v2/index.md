...
Creates, updates, deletes, gets or lists an <code>aggregators_v2</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="aggregators_v2" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.securityhub.aggregators_v2" /></td></tr>
</tbody></table>
...
linked_regions,
region_linking_mode
FROM aws.securityhub.aggregators_v2
...
```sql
INSERT INTO aws.securityhub.aggregators_v2 (
RegionLinkingMode,
LinkedRegions,
Tags,
ClientToken,
...
- name: aggregators_v2
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the aggregators_v2 resource.
...
```sql
UPDATE aws.securityhub.aggregators_v2
SET 
...
```sql
DELETE FROM aws.securityhub.aggregators_v2
WHERE aggregator_v2_arn = '{{ aggregator_v2_arn }}' --required
AND region = '{{ region }}' --required
;
```
