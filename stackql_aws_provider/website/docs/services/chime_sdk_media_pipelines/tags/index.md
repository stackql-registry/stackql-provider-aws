...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.chime_sdk_media_pipelines.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Lists the tags available for a media pipeline.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes any tags from a media pipeline.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>The ARN of the media pipeline that you want to tag. Consists of the pipeline's endpoint region, resource ID, and pipeline ID.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-arn">
    ...
    <td>The ARN of the media pipeline associated with any tags. The ARN consists of the pipeline's region, resource ID, and pipeline ID.</td>
</tr>
...
```sql
UPDATE aws.chime_sdk_media_pipelines.tags
SET 
