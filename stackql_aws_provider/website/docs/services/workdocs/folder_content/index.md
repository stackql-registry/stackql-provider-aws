...
Creates, updates, deletes, gets or lists a <code>folder_content</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="folder_content" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.workdocs.folder_content" /></td></tr>
</tbody></table>
...
signature,
size
FROM aws.workdocs.folder_content
...
```sql
DELETE FROM aws.workdocs.folder_content
WHERE folder_id = '{{ folder_id }}' --required
AND region = '{{ region }}' --required
AND Authentication = '{{ Authentication }}'
;
