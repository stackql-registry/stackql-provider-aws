...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.partnercentral_channel.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Key-value pairs associated with the resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Lists tags associated with a specific resource.</td>
</tr>
<tr>
...
SELECT
tags
FROM aws.partnercentral_channel.tags
...
```sql
UPDATE aws.partnercentral_channel.tags
SET 
