...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.kendra.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Gets a list of tags associated with a resource. Indexes, FAQs, data sources, and other resources can have tags associated with them.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes a tag from an index, FAQ, data source, or other resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds the specified tag to the specified index, FAQ, data source, or other resource. If the tag already exists, the existing value is replaced with the new value.</td>
</tr>
</tbody>
</table>
