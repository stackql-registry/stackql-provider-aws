--- 
title: read_set_activation_jobs
hide_title: false
hide_table_of_contents: false
keywords:
  - read_set_activation_jobs
  - omics
  - aws
...
Creates, updates, deletes, gets or lists a <code>read_set_activation_jobs</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="read_set_activation_jobs" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.omics.read_set_activation_jobs" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_read_set_activation_job"
    values={[
        { label: 'get_read_set_activation_job', value: 'get_read_set_activation_job' },
        { label: 'list_read_set_activation_jobs', value: 'list_read_set_activation_jobs' }
    ]}
>
<TabItem value="get_read_set_activation_job">
...
<TabItem value="list_read_set_activation_jobs">
...
<tbody>
<tr>
    <td><a href="#get_read_set_activation_job"><CopyableCode code="get_read_set_activation_job" /></a></td>
    ...
    <td></td>
    <td>Returns detailed information about the status of a read set activation job in JSON format.</td>
</tr>
<tr>
    <td><a href="#list_read_set_activation_jobs"><CopyableCode code="list_read_set_activation_jobs" /></a></td>
    <td><CopyableCode code="select" /></td>
    ...
    <td>Retrieves a list of read set activation jobs and returns the metadata in a JSON formatted output. To extract metadata from a read set activation job, use the GetReadSetActivationJob API operation.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-maxResults">
    ...
    <td>The maximum number of read set activation jobs to return in one page of results.</td>
</tr>
