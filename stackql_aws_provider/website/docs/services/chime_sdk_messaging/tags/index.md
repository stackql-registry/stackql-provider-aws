...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.chime_sdk_messaging.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Lists the tags applied to an Amazon Chime SDK messaging resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes the specified tags from the specified Amazon Chime SDK messaging resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Applies the specified tags to the specified Amazon Chime SDK messaging resource.</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.chime_sdk_messaging.tags
...
```sql
UPDATE aws.chime_sdk_messaging.tags
SET 
