...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.networkflowmonitor.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Returns all the tags for a resource.</td>
</tr>
<tr>
...
<tr id="parameter-tagKeys">
    ...
    <td>Keys that you specified when you tagged a resource.</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.networkflowmonitor.tags
...
```sql
UPDATE aws.networkflowmonitor.tags
SET 
tags = '{{ tags }}'
WHERE 
