...
Creates, updates, deletes, gets or lists a <code>converses</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="converses" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.bedrock_runtime.converses" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="converse"
    values={[
        { label: 'converse', value: 'converse' }
    ]}
>
<TabItem value="converse">
...
```sql
EXEC aws.bedrock_runtime.converses.converse 
