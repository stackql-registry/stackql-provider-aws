--- 
title: model_with_response_streams
hide_title: false
hide_table_of_contents: false
keywords:
  - model_with_response_streams
  - bedrock_runtime
  - aws
...
Creates, updates, deletes, gets or lists a <code>model_with_response_streams</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="model_with_response_streams" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.bedrock_runtime.model_with_response_streams" /></td></tr>
</tbody></table>
...
<tr id="parameter-X-Amzn-Bedrock-Accept">
    <td><CopyableCode code="X-Amzn-Bedrock-Accept" /></td>
    <td><code>string</code></td>
...
<Tabs
    defaultValue="invoke_model_with_response_stream"
    values={[
        { label: 'invoke_model_with_response_stream', value: 'invoke_model_with_response_stream' }
    ]}
>
<TabItem value="invoke_model_with_response_stream">
...
```sql
EXEC aws.bedrock_runtime.model_with_response_streams.invoke_model_with_response_stream 
