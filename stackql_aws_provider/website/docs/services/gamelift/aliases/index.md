...
<tr>
    ...
    <td><a href="#parameter-region"><code>region</code></a>, <a href="#parameter-RoutingStrategy"><code>RoutingStrategy</code></a></td>
    <td></td>
...
```sql
EXEC aws.gamelift.aliases.resolve_alias 
@region='{{ region }}' --required 
@@json=
'{
"AliasId": "{{ AliasId }}"
