...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.observabilityadmin.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Lists all tags attached to the specified resource. Supports telemetry rule resources and telemetry pipeline resources.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes tags from a resource. Supports telemetry rule resources and telemetry pipeline resources.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds or updates tags for a resource. Supports telemetry rule resources and telemetry pipeline resources.</td>
</tr>
</tbody>
</table>
...
```sql
UPDATE aws.observabilityadmin.tags
SET 
