...
Creates, updates, deletes, gets or lists a <code>centralization_rules</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="centralization_rules" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.observabilityadmin.centralization_rules" /></td></tr>
</tbody></table>
...
FROM aws.observabilityadmin.centralization_rules
...
```sql
INSERT INTO aws.observabilityadmin.centralization_rules (
RuleName,
Rule,
Tags,
region
...
- name: centralization_rules
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the centralization_rules resource.
    - name: RuleName
      value: "{{ RuleName }}"
    - name: Rule
      description: |
...
```sql
UPDATE aws.observabilityadmin.centralization_rules
SET 
...
```sql
DELETE FROM aws.observabilityadmin.centralization_rules
WHERE region = '{{ region }}' --required
;
```
</TabItem>
