...
<Tabs
    ...
    values={[
        ...
        { label: 'split_shard', value: 'split_shard' },
...
```sql
EXEC aws.kinesis.shards.split_shard 
@region='{{ region }}' --required 
@@json=
'{
"StreamName": "{{ StreamName }}", 
