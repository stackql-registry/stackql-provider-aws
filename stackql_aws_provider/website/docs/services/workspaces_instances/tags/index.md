...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.workspaces_instances.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Collection of tags associated with the WorkSpace Instance.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Retrieves tags for a WorkSpace Instance.</td>
</tr>
<tr>
    <td><a href="#untag_resource"><CopyableCode code="untag_resource" /></a></td>
    <td><CopyableCode code="update" /></td>
    <td><a href="#parameter-region"><code>region</code></a>, <a href="#parameter-WorkspaceInstanceId"><code>WorkspaceInstanceId</code></a>, <a href="#parameter-TagKeys"><code>TagKeys</code></a></td>
    <td></td>
    <td>Removes tags from a WorkSpace Instance.</td>
</tr>
<tr>
    <td><a href="#tag_resource"><CopyableCode code="tag_resource" /></a></td>
    <td><CopyableCode code="update" /></td>
    <td><a href="#parameter-region"><code>region</code></a>, <a href="#parameter-WorkspaceInstanceId"><code>WorkspaceInstanceId</code></a></td>
    <td></td>
    <td>Adds tags to a WorkSpace Instance.</td>
</tr>
</tbody>
</table>
...
SELECT
Tags
FROM aws.workspaces_instances.tags
...
```sql
UPDATE aws.workspaces_instances.tags
SET 
