...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.healthlake.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Returns a list of tags associated with a data store.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Returns a list of all existing tags associated with a data store.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Remove a user-specifed key and value tag from a data store.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Add a user-specifed key and value tag to a data store.</td>
</tr>
</tbody>
</table>
