...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.connectcampaigns.instance_onboarding_jobs" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM aws.connectcampaigns.instance_onboarding_jobs
...
```sql
EXEC aws.connectcampaigns.instance_onboarding_jobs.start_instance_onboarding_job 
