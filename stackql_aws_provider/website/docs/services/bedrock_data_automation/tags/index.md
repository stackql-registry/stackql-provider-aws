...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.bedrock_data_automation.tags" /></td></tr>
</tbody></table>
...
SELECT
tags
FROM aws.bedrock_data_automation.tags
...
```sql
UPDATE aws.bedrock_data_automation.tags
SET 
