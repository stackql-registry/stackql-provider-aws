...
<tr>
    ...
    <td></td>
    <td>Describe email address form the specified Connect Customer instance.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Create new email address in the specified Connect Customer instance. For more information about email addresses, see Create email addresses in the Connect Customer Administrator Guide.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-instance_id"><code>instance_id</code></a>, <a href="#parameter-email_address_id"><code>email_address_id</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Updates an email address metadata. For more information about email addresses, see Create email addresses in the Connect Customer Administrator Guide.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-instance_id"><code>instance_id</code></a>, <a href="#parameter-email_address_id"><code>email_address_id</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Deletes email address from the specified Connect Customer instance.</td>
</tr>
<tr>
...
- name: email_addresses
  props:
    - name: instance_id
      value: "{{ instance_id }}"
      description: Required parameter for the email_addresses resource.
    - name: region
      value: "{{ region }}"
      description: Required parameter for the email_addresses resource.
    - name: Description
...
```sql
UPDATE aws.connect.email_addresses
SET 
...
```sql
EXEC aws.connect.email_addresses.disassociate_email_address_alias 
@email_address_id='{{ email_address_id }}' --required, 
@instance_id='{{ instance_id }}' --required, 
