...
<tr>
    ...
    <td>This API is in preview release for Amazon Connect and is subject to change. Returns a paginated list of all security keys associated with the instance.</td>
</tr>
<tr>
    ...
    <td>This API is in preview release for Amazon Connect and is subject to change. Deletes the specified security key.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-instance_id"><code>instance_id</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>This API is in preview release for Amazon Connect and is subject to change. Associates a security key to the instance.</td>
</tr>
</tbody>
</table>
