...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.amplifyuibuilder.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>A list of tag key value pairs for a specified Amazon Resource Name (ARN).</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Returns a list of tags for a specified Amazon Resource Name (ARN).</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Tags the resource with a tag key and value.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Untags a resource with a specified Amazon Resource Name (ARN).</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.amplifyuibuilder.tags
...
```sql
UPDATE aws.amplifyuibuilder.tags
SET 
tags = '{{ tags }}'
WHERE 
