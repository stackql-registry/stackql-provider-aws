--- 
title: compliance_details_by_resources
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>compliance_details_by_resources</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="compliance_details_by_resources" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.config.compliance_details_by_resources" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_compliance_details_by_resource"
    values={[
        { label: 'get_compliance_details_by_resource', value: 'get_compliance_details_by_resource' }
    ]}
>
<TabItem value="get_compliance_details_by_resource">
...
<tbody>
<tr>
    <td><a href="#get_compliance_details_by_resource"><CopyableCode code="get_compliance_details_by_resource" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Returns the evaluation results for the specified Amazon Web Services resource. The results indicate which Config rules were used to evaluate the resource, when each rule was last invoked, and whether the resource complies with each rule.</td>
</tr>
</tbody>
</table>
