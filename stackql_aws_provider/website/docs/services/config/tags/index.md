...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.config.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>List the tags for Config resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Associates the specified tags to a resource with the specified ResourceArn. If existing tags on a resource are not specified in the request parameters, they are not changed. If existing tags are specified, however, then their values will be updated. When a resource is deleted, the tags associated with that resource are deleted as well.</td>
</tr>
<tr>
