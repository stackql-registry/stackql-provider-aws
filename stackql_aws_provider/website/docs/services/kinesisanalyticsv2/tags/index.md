...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.kinesisanalyticsv2.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Removes one or more tags from a Managed Service for Apache Flink application. For more information, see Using Tagging.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds one or more key-value tags to a Managed Service for Apache Flink application. Note that the maximum number of application tags includes system tags. The maximum number of user-defined application tags is 50. For more information, see Using Tagging.</td>
</tr>
</tbody>
</table>
