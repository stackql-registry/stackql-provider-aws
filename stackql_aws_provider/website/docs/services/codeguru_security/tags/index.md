...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.codeguru_security.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Returns a list of all tags associated with a scan.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Use to add one or more tags to an existing scan.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Use to remove one or more tags from an existing scan.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The ARN of the ScanName object. You can retrieve this ARN by calling CreateScan, ListScans, or GetScan.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>A list of keys for each tag you want to remove from a scan.</td>
</tr>
</tbody>
</table>
