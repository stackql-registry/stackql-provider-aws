...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.transfer.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Attaches a key-value pair to a resource, as identified by its Amazon Resource Name (ARN). Resources are users, servers, roles, and other entities. There is no response returned from this call.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Detaches a key-value pair from a resource, as identified by its Amazon Resource Name (ARN). Resources are users, servers, roles, and other entities. No response is returned from this call.</td>
</tr>
</tbody>
</table>
