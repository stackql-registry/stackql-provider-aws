...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.partnercentral_benefits.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>A list of key-value pairs representing the tags associated with the resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Retrieves all tags associated with a specific resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds or updates tags for a specified resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes specified tags from a resource.</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.partnercentral_benefits.tags
...
```sql
UPDATE aws.partnercentral_benefits.tags
SET 
