...
Creates, updates, deletes, gets or lists a <code>step_consumers</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="step_consumers" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.deadline.step_consumers" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_step_consumers"
    values={[
        { label: 'list_step_consumers', value: 'list_step_consumers' }
    ]}
>
<TabItem value="list_step_consumers">
...
<tbody>
<tr>
    <td><a href="#list_step_consumers"><CopyableCode code="list_step_consumers" /></a></td>
...
<tr id="parameter-farm_id">
    ...
    <td><code>string</code></td>
    <td>The farm ID for the list of step consumers.</td>
</tr>
<tr id="parameter-job_id">
    <td><CopyableCode code="job_id" /></td>
    <td><code>string</code></td>
    <td>The job ID for the step consumer.</td>
</tr>
<tr id="parameter-queue_id">
    <td><CopyableCode code="queue_id" /></td>
    <td><code>string</code></td>
    <td>The queue ID for the step consumer.</td>
</tr>
