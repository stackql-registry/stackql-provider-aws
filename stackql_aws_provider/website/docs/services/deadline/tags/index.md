...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.deadline.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Each tag consists of a tag key and a tag value. Tag keys and values are both required, but tag values can be empty strings.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Removes a tag from a resource using the resource's ARN and tag to remove.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_arn"><code>resource_arn</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Tags a resource using the resource's ARN and desired tags.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The ARN of the resource to apply tags to.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>They keys of the tag.</td>
</tr>
</tbody>
</table>
