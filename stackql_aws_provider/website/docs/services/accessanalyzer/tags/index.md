...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.accessanalyzer.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The tags that are applied to the specified resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Retrieves a list of tags applied to the specified resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds a tag to the specified resource.</td>
</tr>
<tr>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The ARN of the resource to remove the tag from.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>The key for the tag to add.</td>
</tr>
</tbody>
</table>
...
```sql
UPDATE aws.accessanalyzer.tags
SET 
tags = '{{ tags }}'
WHERE 
