...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.service_quotas.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>A complex data type that contains zero or more tag elements.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Returns a list of the tags assigned to the specified applied quota.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes tags from the specified applied quota. You can specify one or more tags to remove.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds tags to the specified applied quota. You can include one or more tags to add to the quota.</td>
</tr>
</tbody>
</table>
