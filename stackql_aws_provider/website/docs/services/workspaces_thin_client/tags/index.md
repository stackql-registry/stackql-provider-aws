...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.workspaces_thin_client.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Returns a list of tags for a resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Assigns one or more tags (key-value pairs) to the specified resource.</td>
</tr>
<tr>
...
<tr id="parameter-tagKeys">
    ...
    <td>The keys of the key-value pairs for the tag or tags you want to remove from the specified resource.</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.workspaces_thin_client.tags
...
```sql
UPDATE aws.workspaces_thin_client.tags
SET 
tags = '{{ tags }}'
WHERE 
