--- 
title: organizations_accesses
hide_title: false
hide_table_of_contents: false
keywords:
  - organizations_accesses
  - cloudformation
  - aws
...
Creates, updates, deletes, gets or lists an <code>organizations_accesses</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="organizations_accesses" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.cloudformation.organizations_accesses" /></td></tr>
</tbody></table>
...
SELECT
line_items
FROM aws.cloudformation.organizations_accesses
...
```sql
EXEC aws.cloudformation.organizations_accesses.activate_organizations_access 
...
```sql
EXEC aws.cloudformation.organizations_accesses.deactivate_organizations_access 
@region='{{ region }}' --required
;
```
</TabItem>
