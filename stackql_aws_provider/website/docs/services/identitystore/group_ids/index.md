...
Creates, updates, deletes, gets or lists a <code>group_ids</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="group_ids" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.identitystore.group_ids" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Retrieves GroupId in an identity store. If you have access to a member account, you can use this API operation from the member account. For more information, see Limiting access to the identity store from member accounts in the IAM Identity Center User Guide.</td>
</tr>
</tbody>
</table>
...
group_id,
identity_store_id
FROM aws.identitystore.group_ids
