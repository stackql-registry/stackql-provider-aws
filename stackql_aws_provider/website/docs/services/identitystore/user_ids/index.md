...
Creates, updates, deletes, gets or lists a <code>user_ids</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="user_ids" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.identitystore.user_ids" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_user_id"
    values={[
        { label: 'get_user_id', value: 'get_user_id' }
    ]}
>
<TabItem value="get_user_id">
...
<tbody>
<tr>
    <td><a href="#get_user_id"><CopyableCode code="get_user_id" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Retrieves the UserId in an identity store. If you have access to a member account, you can use this API operation from the member account. For more information, see Limiting access to the identity store from member accounts in the IAM Identity Center User Guide.</td>
</tr>
</tbody>
</table>
