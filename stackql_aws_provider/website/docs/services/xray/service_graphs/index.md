...
Creates, updates, deletes, gets or lists a <code>service_graphs</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="service_graphs" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.xray.service_graphs" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_service_graph"
    values={[
        { label: 'get_service_graph', value: 'get_service_graph' }
    ]}
>
<TabItem value="get_service_graph">
...
<tbody>
<tr>
    <td><a href="#get_service_graph"><CopyableCode code="get_service_graph" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Retrieves a document that describes services that process incoming requests, and downstream services that they call as a result. Root services process incoming requests and make calls to downstream services. Root services are applications that use the Amazon Web Services X-Ray SDK. Downstream services can be other applications, Amazon Web Services resources, HTTP web APIs, or SQL databases.</td>
</tr>
</tbody>
</table>
