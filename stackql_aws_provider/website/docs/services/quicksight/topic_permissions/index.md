...
Creates, updates, deletes, gets or lists a <code>topic_permissions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="topic_permissions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.quicksight.topic_permissions" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="describe_topic_permissions"
    values={[
        { label: 'describe_topic_permissions', value: 'describe_topic_permissions' }
    ]}
>
<TabItem value="describe_topic_permissions">
...
<tbody>
<tr>
    <td><a href="#describe_topic_permissions"><CopyableCode code="describe_topic_permissions" /></a></td>
...
<tr>
    <td><a href="#update_topic_permissions"><CopyableCode code="update_topic_permissions" /></a></td>
...
topic_arn,
topic_id
FROM aws.quicksight.topic_permissions
...
<Tabs
    defaultValue="update_topic_permissions"
    values={[
        { label: 'update_topic_permissions', value: 'update_topic_permissions' }
    ]}
>
<TabItem value="update_topic_permissions">

Updates the permissions of a topic.

```sql
UPDATE aws.quicksight.topic_permissions
SET 
