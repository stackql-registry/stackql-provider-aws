--- 
title: folder_resolved_permissions
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>folder_resolved_permissions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="folder_resolved_permissions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.quicksight.folder_resolved_permissions" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="describe_folder_resolved_permissions"
    values={[
        { label: 'describe_folder_resolved_permissions', value: 'describe_folder_resolved_permissions' }
    ]}
>
<TabItem value="describe_folder_resolved_permissions">
...
<tbody>
<tr>
    <td><a href="#describe_folder_resolved_permissions"><CopyableCode code="describe_folder_resolved_permissions" /></a></td>
    ...
    <td>Describes the folder resolved permissions. Permissions consists of both folder direct permissions and the inherited permissions from the ancestor folders.</td>
</tr>
</tbody>
</table>
