...
Creates, updates, deletes, gets or lists a <code>data_set_export_tasks</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="data_set_export_tasks" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.m2.data_set_export_tasks" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_data_set_export_task"
    values={[
        { label: 'get_data_set_export_task', value: 'get_data_set_export_task' }
    ]}
>
<TabItem value="get_data_set_export_task">
...
<tbody>
<tr>
    <td><a href="#get_data_set_export_task"><CopyableCode code="get_data_set_export_task" /></a></td>
    ...
    <td></td>
    <td>Gets the status of a data set import task initiated with the CreateDataSetExportTask operation.</td>
</tr>
<tr>
    <td><a href="#create_data_set_export_task"><CopyableCode code="create_data_set_export_task" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-application_id"><code>application_id</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-exportConfig"><code>exportConfig</code></a></td>
    <td></td>
    <td>Starts a data set export task for a specific application.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-application_id">
    ...
    <td><code>string</code></td>
    <td>The unique identifier of the application for which you want to export data sets.</td>
</tr>
...
<tr id="parameter-task_id">
    ...
    <td><code>string</code></td>
    <td>The task identifier returned by the CreateDataSetExportTask operation.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="create_data_set_export_task"
    values={[
        { label: 'create_data_set_export_task', value: 'create_data_set_export_task' },
        { label: 'Manifest', value: 'manifest' }
    ]}
>
<TabItem value="create_data_set_export_task">
