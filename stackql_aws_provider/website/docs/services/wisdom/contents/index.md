...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.wisdom.contents" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the content. (pattern: &lt;code&gt;^arn:&#91;a-z-&#93;*?:wisdom:&#91;a-z0-9-&#93;*?:&#91;0-9&#93;&#123;12&#125;:&#91;a-z-&#93;*?/&#91;a-f0-9&#93;&#123;8&#125;-&#91;a-f0-9&#93;&#123;4&#125;-&#91;a-f0-9&#93;&#123;4&#125;-&#91;a-f0-9&#93;&#123;4&#125;-&#91;a-f0-9&#93;&#123;12&#125;(?:/&#91;a-f0-9&#93;&#123;8&#125;-&#91;a-f0-9&#93;&#123;4&#125;-&#91;a-f0-9&#93;&#123;4&#125;-&#91;a-f0-9&#93;&#123;4&#125;-&#91;a-f0-9&#93;&#123;12&#125;)?$&lt;/code&gt;)</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="linkOutUri" /></td>
    <td><code>string</code></td>
...
<tr>
    ...
    <td>A key/value map to store attributes without affecting tagging or recommendations. For example, when synchronizing data between an external system and Wisdom, you can store an external version identifier as metadata to utilize for determining drift.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Creates Wisdom content. Before to calling this API, use StartContentUpload to upload an asset.</td>
</tr>
<tr>
...
<tr id="parameter-knowledge_base_id">
    ...
    <td><code>string</code></td>
    <td>The identifier of the knowledge base. This should not be a QUICK_RESPONSES type knowledge base if you're storing Wisdom Content resource to it. Can be either the ID or the ARN. URLs cannot contain the ARN.</td>
</tr>
...
```sql
INSERT INTO aws.wisdom.contents (
clientToken,
metadata,
name,
overrideLinkOutUri,
...
uploadId = '{{ uploadId }}'
WHERE 
content_id = '{{ content_id }}' --required
AND knowledge_base_id = '{{ knowledge_base_id }}' --required
AND region = '{{ region }}' --required
RETURNING
content;
...
```sql
DELETE FROM aws.wisdom.contents
WHERE content_id = '{{ content_id }}' --required
AND knowledge_base_id = '{{ knowledge_base_id }}' --required
AND region = '{{ region }}' --required
;
...
```sql
EXEC aws.wisdom.contents.start_content_upload 
