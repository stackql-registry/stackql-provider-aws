...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.repostspace.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The list of tags that are associated with the resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Returns the tags that are associated with the AWS re:Post Private resource specified by the resourceArn. The only resource that can be tagged is a private re:Post.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Associates tags with an AWS re:Post Private resource. Currently, the only resource that can be tagged is the private re:Post. If you specify a new tag key for the resource, the tag is appended to the list of tags that are associated with the resource. If you specify a tag key that’s already associated with the resource, the new tag value that you specify replaces the previous value for that tag.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes the association of the tag with the AWS re:Post Private resource.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-tagKeys">
    ...
    <td>The key values of the tag.</td>
</tr>
</tbody>
</table>
