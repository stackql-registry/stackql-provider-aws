...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.chime_sdk_voice.available_phone_numbers" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Confines a search to just the phone numbers in the E.164 format.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Searches the provisioned phone numbers in an organization.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-area-code">
    ...
    <td><code>string</code></td>
    <td>Confines a search to just the phone numbers associated with the specified area code.</td>
</tr>
<tr id="parameter-city">
    <td><CopyableCode code="city" /></td>
    <td><code>string</code></td>
    <td>Confines a search to just the phone numbers associated with the specified city.</td>
</tr>
<tr id="parameter-country">
    <td><CopyableCode code="country" /></td>
    <td><code>string</code></td>
    <td>Confines a search to just the phone numbers associated with the specified country.</td>
</tr>
...
<tr id="parameter-phone-number-type">
    ...
    <td><code>string</code></td>
    <td>Confines a search to just the phone numbers associated with the specified phone number type, either local or toll-free.</td>
</tr>
<tr id="parameter-state">
    <td><CopyableCode code="state" /></td>
    <td><code>string</code></td>
    <td>Confines a search to just the phone numbers associated with the specified state.</td>
</tr>
<tr id="parameter-toll-free-prefix">
    <td><CopyableCode code="toll-free-prefix" /></td>
    <td><code>string</code></td>
    <td>Confines a search to just the phone numbers associated with the specified toll-free prefix.</td>
</tr>
</tbody>
</table>
