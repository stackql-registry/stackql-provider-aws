...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.license_manager_linux_subscriptions.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The metadata tags for the requested resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>List the metadata tags that are assigned to the specified Amazon Web Services resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Add metadata tags to the specified Amazon Web Services resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Remove one or more metadata tag from the specified Amazon Web Services resource.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the Amazon Web Services resource to remove the metadata tags from.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>A list of metadata tag keys to remove from the requested resource.</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.license_manager_linux_subscriptions.tags
...
```sql
UPDATE aws.license_manager_linux_subscriptions.tags
SET 
tags = '{{ tags }}'
WHERE 
