...
Creates, updates, deletes, gets or lists a <code>raw_message_content</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="raw_message_content" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.workmailmessageflow.raw_message_content" /></td></tr>
</tbody></table>
...
SELECT
message_content
FROM aws.workmailmessageflow.raw_message_content
...
```sql
REPLACE aws.workmailmessageflow.raw_message_content
SET 
content = '{{ content }}'
WHERE 
