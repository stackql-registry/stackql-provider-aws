...
Creates, updates, deletes, gets or lists an <code>auto_ml_jobs_v2</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="auto_ml_jobs_v2" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.sagemaker.auto_ml_jobs_v2" /></td></tr>
</tbody></table>
...
role_arn,
security_config
FROM aws.sagemaker.auto_ml_jobs_v2
...
```sql
INSERT INTO aws.sagemaker.auto_ml_jobs_v2 (
AutoMLJobName,
...
- name: auto_ml_jobs_v2
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the auto_ml_jobs_v2 resource.
    - name: AutoMLJobName
      value: "{{ AutoMLJobName }}"
      description: |
