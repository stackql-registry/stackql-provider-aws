...
Creates, updates, deletes, gets or lists a <code>hub_content</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="hub_content" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.sagemaker.hub_content" /></td></tr>
</tbody></table>
...
support_status
FROM aws.sagemaker.hub_content
...
```sql
INSERT INTO aws.sagemaker.hub_content (
HubName,
HubContentType,
HubContentName,
HubContentVersion,
...
- name: hub_content
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the hub_content resource.
    - name: HubName
      value: "{{ HubName }}"
      description: |
...
```sql
UPDATE aws.sagemaker.hub_content
SET 
HubName = '{{ HubName }}',
...
```sql
DELETE FROM aws.sagemaker.hub_content
WHERE region = '{{ region }}' --required
;
```
</TabItem>
