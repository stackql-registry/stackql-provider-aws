...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.partnercentral_account.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Lists all tags associated with a specific AWS Partner Central Account resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes specified tags from an AWS Partner Central Account resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds or updates tags for a specified AWS Partner Central Account resource.</td>
</tr>
</tbody>
</table>
...
```sql
UPDATE aws.partnercentral_account.tags
SET 
