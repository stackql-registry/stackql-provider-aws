...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.route53.tags" /></td></tr>
</tbody></table>
...
<Tabs
    ...
    values={[
        ...
        { label: 'list_tags_for_resources', value: 'list_tags_for_resources' }
    ]}
>
...
<TabItem value="list_tags_for_resources">
...
<tr>
    ...
    <td></td>
    <td>Lists tags for one health check or hosted zone. For information about using tags for cost allocation, see Using Cost Allocation Tags in the Billing and Cost Management User Guide.</td>
</tr>
<tr>
    <td><a href="#list_tags_for_resources"><CopyableCode code="list_tags_for_resources" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-resource_type"><code>resource_type</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Lists tags for up to 10 health checks or hosted zones. For information about using tags for cost allocation, see Using Cost Allocation Tags in the Billing and Cost Management User Guide.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_id">
    ...
    <td><code>string</code></td>
    <td>The ID of the resource for which you want to retrieve tags.</td>
</tr>
<tr id="parameter-resource_type">
    <td><CopyableCode code="resource_type" /></td>
    <td><code>string</code></td>
    <td>The type of the resources. The resource type for health checks is healthcheck. The resource type for hosted zones is hostedzone.</td>
</tr>
</tbody>
</table>
