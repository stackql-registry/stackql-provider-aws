...
<tr>
    <td><CopyableCode code="health_score_threshold" /></td>
...
<tr>
    <td><CopyableCode code="percent_of_total_traffic_impacted" /></td>
    <td><code>number (double)</code></td>
