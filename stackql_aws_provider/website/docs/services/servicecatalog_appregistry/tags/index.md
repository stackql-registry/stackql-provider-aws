...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.servicecatalog_appregistry.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The tags on the resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Lists all of the tags on the resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Assigns one or more tags (key-value pairs) to the specified resource. Each tag consists of a key and an optional value. If a tag with the same key is already associated with the resource, this action updates its value. This operation returns an empty response if the call was successful.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes tags from a resource. This operation returns an empty response if the call was successful.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon resource name (ARN) that specifies the resource.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>A list of the tag keys to remove from the specified resource.</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.servicecatalog_appregistry.tags
...
```sql
UPDATE aws.servicecatalog_appregistry.tags
SET 
tags = '{{ tags }}'
WHERE 
