...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.bedrock_agentcore_control.resource_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The resource policy associated with the specified resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Retrieves the resource-based policy for a specified resource. This feature is currently available only for AgentCore Runtime and Gateway.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Creates or updates a resource-based policy for a resource with the specified resourceArn. This feature is currently available only for AgentCore Runtime and Gateway.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_arn"><code>resource_arn</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Deletes the resource-based policy for a specified resource. This feature is currently available only for AgentCore Runtime and Gateway.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the resource for which to delete the resource policy.</td>
</tr>
</tbody>
</table>
