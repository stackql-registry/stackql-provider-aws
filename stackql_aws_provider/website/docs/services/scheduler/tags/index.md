...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.scheduler.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Lists the tags associated with the Scheduler resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes one or more tags from the specified EventBridge Scheduler schedule group.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_arn"><code>resource_arn</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Assigns one or more tags (key-value pairs) to the specified EventBridge Scheduler resource. You can only assign tags to schedule groups.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the schedule group that you are adding tags to.</td>
</tr>
</tbody>
</table>
