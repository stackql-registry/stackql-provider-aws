...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.vpc_lattice.resource_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>An IAM policy. (pattern: &lt;code&gt;.*\S.*&lt;/code&gt;)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Retrieves information about the specified resource policy. The resource policy is an IAM policy created on behalf of the resource owner when they share a resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Attaches a resource-based permission policy to a service or service network. The policy must contain the same actions and condition statements as the Amazon Web Services Resource Access Manager permission for sharing services and service networks.</td>
</tr>
<tr>
