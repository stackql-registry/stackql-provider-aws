...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.snow_device_management.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The list of tags for the device or task.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Returns a list of tags for a managed device or task.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds or replaces tags on a device or task.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes a tag from a device or task.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the device or task.</td>
</tr>
...
SELECT
tags
FROM aws.snow_device_management.tags
...
```sql
UPDATE aws.snow_device_management.tags
SET 
tags = '{{ tags }}'
WHERE 
