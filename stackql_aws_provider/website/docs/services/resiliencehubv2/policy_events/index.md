...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.resiliencehubv2.policy_events" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_policy_events"
    values={[
        { label: 'list_policy_events', value: 'list_policy_events' }
    ]}
>
<TabItem value="list_policy_events">
...
<tr>
    ...
    <td>The identifier of the event. (pattern: &lt;code&gt;&#91;0-9a-f&#93;&#123;8&#125;-&#91;0-9a-f&#93;&#123;4&#125;-&#91;0-5&#93;&#91;0-9a-f&#93;&#123;3&#125;-&#91;089ab&#93;&#91;0-9a-f&#93;&#123;3&#125;-&#91;0-9a-f&#93;&#123;12&#125;&lt;/code&gt;)</td>
</tr>
<tr>
    <td><CopyableCode code="event_type" /></td>
    <td><code>string</code></td>
    <td>The type of the event. (POLICY_ATTACHED_TO_SERVICE, POLICY_DETACHED_FROM_SERVICE, POLICY_SHARING_REVOKED, POLICY_DELETED)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>The time the event occurred.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tbody>
<tr>
    <td><a href="#list_policy_events"><CopyableCode code="list_policy_events" /></a></td>
    ...
    <td>Lists events for a resilience policy, including services that started or stopped using it, changes to cross-account sharing, and deletion of the policy.</td>
</tr>
</tbody>
</table>
...
policy_arn,
timestamp
FROM aws.resiliencehubv2.policy_events
