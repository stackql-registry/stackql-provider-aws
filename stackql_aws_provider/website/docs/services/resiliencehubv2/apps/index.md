...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.resiliencehubv2.apps" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-region"><code>region</code></a>, <a href="#parameter-v1AppArn"><code>v1AppArn</code></a></td>
    <td></td>
    <td>Imports a V1 app into the V2 resource model, creating a service with the same name.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC aws.resiliencehubv2.apps.import_app 
