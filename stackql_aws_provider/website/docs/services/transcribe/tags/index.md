...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.transcribe.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Lists all tags associated with the specified transcription job, vocabulary, model, or resource. To learn more about using tags with Amazon Transcribe, refer to Tagging resources.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes the specified tags from the specified Amazon Transcribe resource. If you include UntagResource in your request, you must also include ResourceArn and TagKeys.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds one or more custom tags, each in the form of a key:value pair, to the specified resource. To learn more about using tags with Amazon Transcribe, refer to Tagging resources.</td>
</tr>
</tbody>
</table>
