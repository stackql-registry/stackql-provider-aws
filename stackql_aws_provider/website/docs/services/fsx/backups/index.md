...
<Tabs
    defaultValue="copy_backup"
    values={[
        { label: 'copy_backup', value: 'copy_backup' }
    ]}
>
<TabItem value="copy_backup">
...
```sql
EXEC aws.fsx.backups.copy_backup 
