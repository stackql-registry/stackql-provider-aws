...
Creates, updates, deletes, gets or lists a <code>backend_storage</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="backend_storage" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.amplifybackend.backend_storage" /></td></tr>
</tbody></table>
...
resource_config,
resource_name
FROM aws.amplifybackend.backend_storage
...
```sql
INSERT INTO aws.amplifybackend.backend_storage (
...
- name: backend_storage
  props:
    - name: app_id
      value: "{{ app_id }}"
      description: Required parameter for the backend_storage resource.
    - name: region
      value: "{{ region }}"
      description: Required parameter for the backend_storage resource.
...
```sql
UPDATE aws.amplifybackend.backend_storage
SET 
...
```sql
DELETE FROM aws.amplifybackend.backend_storage
WHERE app_id = '{{ app_id }}' --required
AND backend_environment_name = '{{ backend_environment_name }}' --required
AND region = '{{ region }}' --required
;
