...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.opensearch.vpc_endpoint_accesses" /></td></tr>
</tbody></table>
...
next_token
FROM aws.opensearch.vpc_endpoint_accesses
...
```sql
UPDATE aws.opensearch.vpc_endpoint_accesses
SET 
Account = '{{ Account }}',
Service = '{{ Service }}',
...
```sql
EXEC aws.opensearch.vpc_endpoint_accesses.revoke_vpc_endpoint_access 
@domain_name='{{ domain_name }}' --required, 
