...
Creates, updates, deletes, gets or lists an <code>attached_role_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="attached_role_policies" /></td></tr>
...
<Tabs
    defaultValue="list_attached_role_policies"
    values={[
        { label: 'list_attached_role_policies', value: 'list_attached_role_policies' }
    ]}
>
<TabItem value="list_attached_role_policies">
...
<tbody>
<tr>
    <td><a href="#list_attached_role_policies"><CopyableCode code="list_attached_role_policies" /></a></td>
...
<tr id="parameter-RoleName">
    ...
    <td><code>string</code></td>
    <td>The name (friendly name, not ARN) of the role to list attached policies for. This parameter allows (through its regex pattern) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</td>
</tr>
