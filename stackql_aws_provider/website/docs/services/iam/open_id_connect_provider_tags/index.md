...
Creates, updates, deletes, gets or lists an <code>open_id_connect_provider_tags</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="open_id_connect_provider_tags" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iam.open_id_connect_provider_tags" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_open_id_connect_provider_tags"
    values={[
        { label: 'list_open_id_connect_provider_tags', value: 'list_open_id_connect_provider_tags' }
    ]}
>
<TabItem value="list_open_id_connect_provider_tags">
...
<tbody>
<tr>
    <td><a href="#list_open_id_connect_provider_tags"><CopyableCode code="list_open_id_connect_provider_tags" /></a></td>
    ...
    <td>Lists the tags that are attached to the specified OpenID Connect (OIDC)-compatible identity provider. The returned list of tags is sorted by tag key. For more information, see About web identity federation. For more information about tagging, see Tagging IAM resources in the IAM User Guide.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-OpenIDConnectProviderArn">
    ...
    <td><code>string</code></td>
    <td>The ARN of the OpenID Connect (OIDC) identity provider whose tags you want to see. This parameter allows (through its regex pattern) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</td>
</tr>
...
Key,
Value
FROM aws.iam.open_id_connect_provider_tags
