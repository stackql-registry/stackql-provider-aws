...
Creates, updates, deletes, gets or lists an <code>instance_profile_tags</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="instance_profile_tags" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iam.instance_profile_tags" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_instance_profile_tags"
    values={[
        { label: 'list_instance_profile_tags', value: 'list_instance_profile_tags' }
    ]}
>
<TabItem value="list_instance_profile_tags">
...
<tbody>
<tr>
    <td><a href="#list_instance_profile_tags"><CopyableCode code="list_instance_profile_tags" /></a></td>
    ...
    <td>Lists the tags that are attached to the specified IAM instance profile. The returned list of tags is sorted by tag key. For more information about tagging, see Tagging IAM resources in the IAM User Guide.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-InstanceProfileName">
    ...
    <td><code>string</code></td>
    <td>The name of the IAM instance profile whose tags you want to see. This parameter allows (through its regex pattern) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</td>
</tr>
...
key,
value
FROM aws.iam.instance_profile_tags
