...
Creates, updates, deletes, gets or lists a <code>mfa_device_tags</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="mfa_device_tags" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iam.mfa_device_tags" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_mfa_device_tags"
    values={[
        { label: 'list_mfa_device_tags', value: 'list_mfa_device_tags' }
    ]}
>
<TabItem value="list_mfa_device_tags">
...
<tbody>
<tr>
    <td><a href="#list_mfa_device_tags"><CopyableCode code="list_mfa_device_tags" /></a></td>
    ...
    <td>Lists the tags that are attached to the specified IAM virtual multi-factor authentication (MFA) device. The returned list of tags is sorted by tag key. For more information about tagging, see Tagging IAM resources in the IAM User Guide.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-SerialNumber">
    ...
    <td><code>string</code></td>
    <td>The unique identifier for the IAM virtual MFA device whose tags you want to see. For virtual MFA devices, the serial number is the same as the ARN. This parameter allows (through its regex pattern) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</td>
</tr>
