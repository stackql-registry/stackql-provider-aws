...
Creates, updates, deletes, gets or lists an <code>instance_profiles_for_roles</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="instance_profiles_for_roles" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iam.instance_profiles_for_roles" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_instance_profiles_for_role"
    values={[
...
<tr id="parameter-RoleName">
    ...
    <td><code>string</code></td>
    <td>The name of the role to list instance profiles for. This parameter allows (through its regex pattern) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</td>
</tr>
...
roles,
tags
FROM aws.iam.instance_profiles_for_roles
