...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.databrew.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>A list of tags associated with the DataBrew resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Lists all the tags for a DataBrew resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes metadata tags from a DataBrew resource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_arn"><code>resource_arn</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Adds metadata tags to a DataBrew resource, such as a dataset, project, recipe, job, or schedule.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The DataBrew resource to which tags should be added. The value for this parameter is an Amazon Resource Name (ARN). For DataBrew, you can tag a dataset, a job, a project, or a recipe.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>The tag keys (names) of one or more tags to be removed.</td>
</tr>
</tbody>
</table>
