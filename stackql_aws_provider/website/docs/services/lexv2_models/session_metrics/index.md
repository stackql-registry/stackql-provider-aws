...
Creates, updates, deletes, gets or lists a <code>session_metrics</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="session_metrics" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.lexv2_models.session_metrics" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_session_metrics"
    values={[
        { label: 'list_session_metrics', value: 'list_session_metrics' }
    ]}
>
<TabItem value="list_session_metrics">
...
<tr id="parameter-bot_id">
    <td><CopyableCode code="bot_id" /></td>
    <td><code>string</code></td>
    <td>The identifier for the bot for which you want to retrieve session metrics.</td>
</tr>
...
next_token,
results
FROM aws.lexv2_models.session_metrics
