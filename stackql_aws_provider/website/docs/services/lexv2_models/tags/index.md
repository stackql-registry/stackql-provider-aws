...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.lexv2_models.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The tags associated with a resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Gets a list of tags associated with a resource. Only bots, bot aliases, and bot channels can have tags associated with them.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds the specified tags to the specified resource. If a tag key already exists, the existing value is replaced with the new value.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes tags from a bot, bot alias, or bot channel.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the resource to remove the tags from.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>A list of tag keys to remove from the resource. If a tag key does not exist on the resource, it is ignored.</td>
</tr>
</tbody>
</table>
