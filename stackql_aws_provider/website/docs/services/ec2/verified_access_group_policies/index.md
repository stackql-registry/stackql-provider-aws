--- 
title: verified_access_group_policies
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>verified_access_group_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="verified_access_group_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.ec2.verified_access_group_policies" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_verified_access_group_policy"
    values={[
        { label: 'get_verified_access_group_policy', value: 'get_verified_access_group_policy' }
    ]}
>
<TabItem value="get_verified_access_group_policy">
...
<tbody>
<tr>
    <td><a href="#get_verified_access_group_policy"><CopyableCode code="get_verified_access_group_policy" /></a></td>
    ...
    <td>Shows the contents of the Verified Access policy associated with the group.</td>
</tr>
<tr>
    <td><a href="#modify_verified_access_group_policy"><CopyableCode code="modify_verified_access_group_policy" /></a></td>
    ...
    <td>Modifies the specified Amazon Web Services Verified Access group policy.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="modify_verified_access_group_policy"
    values={[
        { label: 'modify_verified_access_group_policy', value: 'modify_verified_access_group_policy' }
    ]}
>
<TabItem value="modify_verified_access_group_policy">
