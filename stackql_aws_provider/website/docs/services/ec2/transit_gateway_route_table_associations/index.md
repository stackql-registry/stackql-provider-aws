...
Creates, updates, deletes, gets or lists a <code>transit_gateway_route_table_associations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="transit_gateway_route_table_associations" /></td></tr>
...
<Tabs
    defaultValue="get_transit_gateway_route_table_associations"
    values={[
        { label: 'get_transit_gateway_route_table_associations', value: 'get_transit_gateway_route_table_associations' }
    ]}
>
<TabItem value="get_transit_gateway_route_table_associations">
...
<tbody>
<tr>
    <td><a href="#get_transit_gateway_route_table_associations"><CopyableCode code="get_transit_gateway_route_table_associations" /></a></td>
    ...
    <td>Gets information about the associations for the specified transit gateway route table.</td>
</tr>
</tbody>
</table>
