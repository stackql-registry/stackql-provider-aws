...
<tr>
    <td><a href="#update_bucket_metadata_annotation_table_configuration"><CopyableCode code="update_bucket_metadata_annotation_table_configuration" /></a></td>
    <td><CopyableCode code="update" /></td>
    <td><a href="#parameter-bucket"><code>bucket</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-AnnotationTableConfiguration"><code>AnnotationTableConfiguration</code></a></td>
...
<Tabs
    defaultValue="update_bucket_metadata_annotation_table_configuration"
    values={[
        { label: 'update_bucket_metadata_annotation_table_configuration', value: 'update_bucket_metadata_annotation_table_configuration' },
...
AND AnnotationTableConfiguration = '{{ AnnotationTableConfiguration }}' --required
...
<Tabs
    defaultValue="head_bucket"
    values={[
        { label: 'head_bucket', value: 'head_bucket' }
    ]}
>
<TabItem value="head_bucket">
...
```sql
EXEC aws.s3.buckets.head_bucket 
@bucket='{{ bucket }}' --required, 
