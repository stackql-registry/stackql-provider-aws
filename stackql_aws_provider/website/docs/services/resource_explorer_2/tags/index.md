...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.resource_explorer_2.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Lists the tags that are attached to the specified resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes one or more tag key and value pairs from an Amazon Web Services Resource Explorer view or index.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_arn"><code>resource_arn</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Adds one or more tag key and value pairs to an Amazon Web Services Resource Explorer view or index.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the view or index that you want to attach tags to.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>A list of the keys for the tags that you want to remove from the specified view or index.</td>
</tr>
</tbody>
</table>
