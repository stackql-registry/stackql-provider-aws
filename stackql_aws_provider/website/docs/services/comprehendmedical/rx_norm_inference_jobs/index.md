...
Creates, updates, deletes, gets or lists a <code>rx_norm_inference_jobs</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="rx_norm_inference_jobs" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.comprehendmedical.rx_norm_inference_jobs" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="describe_rx_norm_inference_job"
    values={[
        { label: 'describe_rx_norm_inference_job', value: 'describe_rx_norm_inference_job' },
        { label: 'list_rx_norm_inference_jobs', value: 'list_rx_norm_inference_jobs' }
    ]}
>
<TabItem value="describe_rx_norm_inference_job">
...
<TabItem value="list_rx_norm_inference_jobs">
...
<tr>
    ...
    <td>The maximum number of results to return in each page. The default is 100.</td>
</tr>
<tr>
...
<tbody>
<tr>
    <td><a href="#describe_rx_norm_inference_job"><CopyableCode code="describe_rx_norm_inference_job" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Gets the properties associated with an InferRxNorm job. Use this operation to get the status of an inference job.</td>
</tr>
<tr>
    <td><a href="#list_rx_norm_inference_jobs"><CopyableCode code="list_rx_norm_inference_jobs" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-region"><code>region</code></a></td>
    <td></td>
