...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.pcs.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>1 or more tags added to the resource. Each tag consists of a tag key and tag value. The tag value is optional and can be an empty string.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Returns a list of all tags on an PCS resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds or edits tags on an PCS resource. Each tag consists of a tag key and a tag value. The tag key and tag value are case-sensitive strings. The tag value can be an empty (null) string. To add a tag, specify a new tag key and a tag value. To edit a tag, specify an existing tag key and a new tag value.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Deletes tags from an PCS resource. To delete a tag, specify the tag key and the Amazon Resource Name (ARN) of the PCS resource.</td>
</tr>
</tbody>
</table>
