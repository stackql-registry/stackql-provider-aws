...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.drs.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The tags of the requested resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>List all tags for your Elastic Disaster Recovery resources.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds or overwrites only the specified tags for the specified Elastic Disaster Recovery resource or resources. When you specify an existing tag key, the value is overwritten with the new value. Each resource can have a maximum of 50 tags. Each tag consists of a key and optional value.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Deletes the specified set of tags from the specified set of Elastic Disaster Recovery resources.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>ARN of the resource for which tags are to be removed.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>Array of tags to be removed.</td>
</tr>
</tbody>
</table>
