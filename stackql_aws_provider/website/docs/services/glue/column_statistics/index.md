...
Creates, updates, deletes, gets or lists a <code>column_statistics</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="column_statistics" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.glue.column_statistics" /></td></tr>
</tbody></table>
...
errors
FROM aws.glue.column_statistics
...
```sql
UPDATE aws.glue.column_statistics
SET 
CatalogId = '{{ CatalogId }}',
...
```sql
DELETE FROM aws.glue.column_statistics
WHERE region = '{{ region }}' --required
;
```
</TabItem>
