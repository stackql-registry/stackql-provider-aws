...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iotsitewise.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The list of key-value pairs that contain metadata for the resource. For more information, see Tagging your IoT SiteWise resources in the IoT SiteWise User Guide.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Retrieves the list of tags for an IoT SiteWise resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds tags to an IoT SiteWise resource. If a tag already exists for the resource, this operation updates the tag's value.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes a tag from an IoT SiteWise resource.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resourceArn">
    ...
    <td><code>string</code></td>
    <td>The ARN of the resource to untag.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>A list of keys for tags to remove from the resource.</td>
</tr>
</tbody>
</table>
