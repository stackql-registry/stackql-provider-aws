...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.mediaconvert.certificates" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Removes an association between the Amazon Resource Name (ARN) of an AWS Certificate Manager (ACM) certificate and an AWS Elemental MediaConvert resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Associates an AWS Certificate Manager (ACM) Amazon Resource Name (ARN) with AWS Elemental MediaConvert.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-arn">
    ...
    <td>The ARN of the ACM certificate that you want to disassociate from your MediaConvert resource.</td>
</tr>
...
<Tabs
    defaultValue="disassociate_certificate"
    values={[
