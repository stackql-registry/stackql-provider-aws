...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.mediaconvert.endpoints" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Send a request with an empty body to the regional API endpoint to get your account API endpoint. Note that DescribeEndpoints is no longer required. We recommend that you send your requests directly to the regional endpoint instead.</td>
</tr>
</tbody>
</table>
