...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iotdeviceadvisor.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The tags attached to the IoT Device Advisor resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Lists the tags attached to an IoT Device Advisor resource. Requires permission to access the ListTagsForResource action.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds to and modifies existing tags of an IoT Device Advisor resource. Requires permission to access the TagResource action.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes tags from an IoT Device Advisor resource. Requires permission to access the UntagResource action.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The resource ARN of an IoT Device Advisor resource. This can be SuiteDefinition ARN or SuiteRun ARN.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>List of tag keys to remove from the IoT Device Advisor resource.</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.iotdeviceadvisor.tags
...
```sql
UPDATE aws.iotdeviceadvisor.tags
SET 
tags = '{{ tags }}'
WHERE 
