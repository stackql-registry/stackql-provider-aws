...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.mediastore.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>An array of key:value pairs that are assigned to the container.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Returns a list of the tags assigned to the specified container.</td>
</tr>
<tr>
    <td><a href="#untag_resource"><CopyableCode code="untag_resource" /></a></td>
    <td><CopyableCode code="update" /></td>
    <td><a href="#parameter-region"><code>region</code></a>, <a href="#parameter-Resource"><code>Resource</code></a>, <a href="#parameter-TagKeys"><code>TagKeys</code></a></td>
    <td></td>
    <td>Removes tags from the specified container. You can specify one or more tags to remove.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds tags to the specified AWS Elemental MediaStore container. Tags are key:value pairs that you can associate with AWS resources. For example, the tag key might be "customer" and the tag value might be "companyA." You can specify one or more tags to add to each container. You can add up to 50 tags to each container. For more information about tagging, including naming and usage conventions, see Tagging Resources in MediaStore.</td>
</tr>
</tbody>
</table>
