...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.pinpoint_sms_voice.configuration_sets" /></td></tr>
</tbody></table>
...
SELECT
configuration_set
FROM aws.pinpoint_sms_voice.configuration_sets
...
```sql
INSERT INTO aws.pinpoint_sms_voice.configuration_sets (
...
```sql
DELETE FROM aws.pinpoint_sms_voice.configuration_sets
