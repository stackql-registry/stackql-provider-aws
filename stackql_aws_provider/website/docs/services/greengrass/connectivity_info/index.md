...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.greengrass.connectivity_info" /></td></tr>
</tbody></table>
...
connectivity_info,
message
FROM aws.greengrass.connectivity_info
...
```sql
UPDATE aws.greengrass.connectivity_info
SET 
