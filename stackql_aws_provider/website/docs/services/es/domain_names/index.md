...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.es.domain_names" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-engineType"><code>engineType</code></a></td>
    <td>Returns the name of all Elasticsearch domains owned by the current user's account.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-engineType">
    ...
    <td><code>string</code></td>
    <td>Optional parameter to filter the output by domain engine type. Acceptable values are 'Elasticsearch' and 'OpenSearch'.</td>
</tr>
</tbody>
</table>
