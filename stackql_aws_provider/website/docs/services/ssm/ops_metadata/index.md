...
Creates, updates, deletes, gets or lists an <code>ops_metadata</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="ops_metadata" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.ssm.ops_metadata" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO aws.ssm.ops_metadata (
ResourceId,
Metadata,
Tags,
region
...
- name: ops_metadata
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the ops_metadata resource.
    - name: ResourceId
      value: "{{ ResourceId }}"
      description: |
...
```sql
DELETE FROM aws.ssm.ops_metadata
WHERE region = '{{ region }}' --required
;
```
</TabItem>
