...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.codeconnections.sync_configurations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The connection provider type associated with a specific sync configuration, such as GitHub. (Bitbucket, GitHub, GitHubEnterpriseServer, GitLab, GitLabSelfManaged, AzureDevOps)</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="pull_request_comment" /></td>
    <td><code>string</code></td>
    <td>A toggle that specifies whether to enable or disable pull request comments for the sync configuration to be created. (ENABLED, DISABLED)</td>
</tr>
<tr>
...
FROM aws.codeconnections.sync_configurations
...
```sql
INSERT INTO aws.codeconnections.sync_configurations (
Branch,
ConfigFile,
RepositoryLinkId,
ResourceName,
...
```sql
UPDATE aws.codeconnections.sync_configurations
SET 
Branch = '{{ Branch }}',
...
```sql
DELETE FROM aws.codeconnections.sync_configurations
WHERE region = '{{ region }}' --required
;
```
</TabItem>
