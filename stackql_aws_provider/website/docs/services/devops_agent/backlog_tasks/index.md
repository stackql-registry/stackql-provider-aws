...
<tr>
    ...
    <td><code>string</code></td>
    <td>The current status of this task (PENDING_TRIAGE, LINKED, PENDING_START, IN_PROGRESS, PENDING_CUSTOMER_APPROVAL, COMPLETED, FAILED, TIMED_OUT, CANCELED, SKIPPED, WAITING)</td>
</tr>
<tr>
