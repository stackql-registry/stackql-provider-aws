...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.ecr.repository_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Applies a repository policy to the specified repository to control access permissions. For more information, see Amazon ECR Repository policies in the Amazon Elastic Container Registry User Guide.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Deletes the repository policy associated with the specified repository.</td>
</tr>
</tbody>
</table>
