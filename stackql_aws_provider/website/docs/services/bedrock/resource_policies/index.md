...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.bedrock.resource_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Gets the resource policy document for a Bedrock resource</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds a resource policy for a Bedrock resource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_arn"><code>resource_arn</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Deletes a previously created Bedrock resource policy.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The ARN of the Bedrock resource to which this resource policy applies.</td>
</tr>
</tbody>
</table>
...
```sql
REPLACE aws.bedrock.resource_policies
SET 
...
```sql
DELETE FROM aws.bedrock.resource_policies
WHERE resource_arn = '{{ resource_arn }}' --required
AND region = '{{ region }}' --required
;
```
