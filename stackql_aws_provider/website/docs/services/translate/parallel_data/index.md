...
Creates, updates, deletes, gets or lists a <code>parallel_data</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="parallel_data" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.translate.parallel_data" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="data_location" /></td>
    <td><code>object</code></td>
...
<tr>
    <td><CopyableCode code="latest_update_attempt_auxiliary_data_location" /></td>
    <td><code>object</code></td>
...
<tr>
    <td><CopyableCode code="parallel_data_properties" /></td>
    <td><code>object</code></td>
...
FROM aws.translate.parallel_data
...
```sql
INSERT INTO aws.translate.parallel_data (
Name,
Description,
ParallelDataConfig,
EncryptionKey,
...
- name: parallel_data
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the parallel_data resource.
    - name: Name
      value: "{{ Name }}"
      description: |
...
```sql
UPDATE aws.translate.parallel_data
SET 
Name = '{{ Name }}',
...
```sql
DELETE FROM aws.translate.parallel_data
WHERE region = '{{ region }}' --required
;
```
</TabItem>
...
```sql
EXEC aws.translate.parallel_data.list_parallel_data 
@region='{{ region }}' --required 
@@json=
'{
"NextToken": "{{ NextToken }}", 
