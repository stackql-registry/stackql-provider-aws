...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.codestar_connections.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Gets the set of key-value pairs (metadata) that are used to manage the resource.</td>
</tr>
<tr>
...
SELECT
Tags
FROM aws.codestar_connections.tags
...
```sql
UPDATE aws.codestar_connections.tags
SET 
