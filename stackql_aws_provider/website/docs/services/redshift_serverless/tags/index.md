...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.redshift_serverless.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>A map of the key-value pairs assigned to the resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Assigns one or more tags to a resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes a tag or set of tags from a resource.</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.redshift_serverless.tags
...
```sql
UPDATE aws.redshift_serverless.tags
SET 
