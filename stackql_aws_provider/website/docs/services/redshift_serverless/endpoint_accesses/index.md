...
Creates, updates, deletes, gets or lists an <code>endpoint_accesses</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="endpoint_accesses" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.redshift_serverless.endpoint_accesses" /></td></tr>
</tbody></table>
...
vpc_security_groups,
workgroup_name
FROM aws.redshift_serverless.endpoint_accesses
...
```sql
INSERT INTO aws.redshift_serverless.endpoint_accesses (
endpointName,
ownerAccount,
subnetIds,
vpcSecurityGroupIds,
...
- name: endpoint_accesses
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the endpoint_accesses resource.
    - name: endpointName
      value: "{{ endpointName }}"
      description: |
...
```sql
UPDATE aws.redshift_serverless.endpoint_accesses
SET 
...
```sql
DELETE FROM aws.redshift_serverless.endpoint_accesses
WHERE region = '{{ region }}' --required
;
```
</TabItem>
