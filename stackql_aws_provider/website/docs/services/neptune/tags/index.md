...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.neptune.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Lists all tags on an Amazon Neptune resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds metadata tags to an Amazon Neptune resource. These tags can also be used with cost allocation reporting to track cost associated with Amazon Neptune resources, or used in a Condition statement in an IAM policy for Amazon Neptune.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes metadata tags from an Amazon Neptune resource.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-ResourceName">
    ...
    <td><code>string</code></td>
    <td>The Amazon Neptune resource that the tags are removed from. This value is an Amazon Resource Name (ARN). For information about creating an ARN, see Constructing an Amazon Resource Name (ARN).</td>
</tr>
...
<tr id="parameter-Tags">
    ...
    <td><code>array</code></td>
    <td>The tags to be assigned to the Amazon Neptune resource.</td>
</tr>
