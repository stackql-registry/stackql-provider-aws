...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.codeguruprofiler.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The list of tags assigned to the specified resource. This is the list of tags returned in the response.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Returns a list of the tags that are assigned to a specified resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Use to assign one or more tags to a resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Use to remove one or more tags from a resource.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the resource that contains the tags to remove.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>A list of tag keys. Existing tags of resources with keys in this list are removed from the specified resource.</td>
</tr>
</tbody>
</table>
