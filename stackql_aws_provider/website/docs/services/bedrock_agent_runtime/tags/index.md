...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.bedrock_agent_runtime.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The key-value pairs for the tags associated with the resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>List all the tags for the resource you specify.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Associate tags with a resource. For more information, see Tagging resources in the Amazon Bedrock User Guide.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Remove tags from a resource.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the resource from which to remove tags.</td>
</tr>
<tr id="parameter-tagKeys">
    <td><CopyableCode code="tagKeys" /></td>
    <td><code>array</code></td>
    <td>A list of keys of the tags to remove from the resource.</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.bedrock_agent_runtime.tags
...
```sql
UPDATE aws.bedrock_agent_runtime.tags
SET 
tags = '{{ tags }}'
WHERE 
