...
Creates, updates, deletes, gets or lists an <code>image_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="image_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.imagebuilder.image_policies" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_image_policy"
    values={[
        { label: 'get_image_policy', value: 'get_image_policy' }
    ]}
>
...
<tbody>
<tr>
    <td><a href="#get_image_policy"><CopyableCode code="get_image_policy" /></a></td>
...
<tbody>
<tr id="parameter-imageArn">
    <td><CopyableCode code="imageArn" /></td>
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the image whose policy you want to retrieve.</td>
</tr>
...
<Tabs
    defaultValue="put_image_policy"
    values={[
        { label: 'put_image_policy', value: 'put_image_policy' }
    ]}
>
