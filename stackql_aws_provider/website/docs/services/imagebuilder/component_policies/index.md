...
<tr>
    ...
    <td></td>
    <td>Retrieves a component policy.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Applies a policy to a component. To share resources, call the RAM API CreateResourceShare. If you call this API, you must also call the RAM API PromoteResourceShareCreatedFromPolicy so that the resource is visible to all principals with whom the resource is shared.</td>
</tr>
</tbody>
</table>
