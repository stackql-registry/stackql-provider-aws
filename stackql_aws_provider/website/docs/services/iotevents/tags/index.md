...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iotevents.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Lists the tags (metadata) you have assigned to the resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds to or modifies the tags of the given resource. Tags are metadata that can be used to manage a resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes the given tags (metadata) from the resource.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-tagKeys">
    ...
    <td><code>array</code></td>
    <td>A list of the keys of the tags to be removed from the resource.</td>
</tr>
</tbody>
</table>
