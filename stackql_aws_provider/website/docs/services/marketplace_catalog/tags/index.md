...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.marketplace_catalog.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Lists all tags that have been added to a resource (either an entity or change set).</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes a tag or list of tags from a resource (either an entity or change set).</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Tags a resource (either an entity or change set).</td>
</tr>
</tbody>
</table>
...
```sql
UPDATE aws.marketplace_catalog.tags
SET 
