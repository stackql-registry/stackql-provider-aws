--- 
title: rds_database_recommendations
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>rds_database_recommendations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="rds_database_recommendations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.compute_optimizer.rds_database_recommendations" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_rds_database_recommendations"
    values={[
        { label: 'get_rds_database_recommendations', value: 'get_rds_database_recommendations' }
    ]}
>
<TabItem value="get_rds_database_recommendations">
...
<tbody>
<tr>
    <td><a href="#get_rds_database_recommendations"><CopyableCode code="get_rds_database_recommendations" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Returns Amazon Aurora and RDS database recommendations. Compute Optimizer generates recommendations for Amazon Aurora and RDS databases that meet a specific set of requirements. For more information, see the Supported resources and requirements in the Compute Optimizer User Guide.</td>
</tr>
<tr>
    <td><a href="#export_rds_database_recommendations"><CopyableCode code="export_rds_database_recommendations" /></a></td>
...
<Tabs
    defaultValue="export_rds_database_recommendations"
    values={[
        { label: 'export_rds_database_recommendations', value: 'export_rds_database_recommendations' }
    ]}
>
<TabItem value="export_rds_database_recommendations">
