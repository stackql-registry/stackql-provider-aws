...
Creates, updates, deletes, gets or lists an <code>idle_recommendations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="idle_recommendations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.compute_optimizer.idle_recommendations" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_idle_recommendations"
    values={[
        { label: 'get_idle_recommendations', value: 'get_idle_recommendations' }
    ]}
>
<TabItem value="get_idle_recommendations">
...
<tbody>
<tr>
    <td><a href="#get_idle_recommendations"><CopyableCode code="get_idle_recommendations" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Returns idle resource recommendations. Compute Optimizer generates recommendations for idle resources that meet a specific set of requirements. For more information, see Resource requirements in the Compute Optimizer User Guide</td>
</tr>
<tr>
    <td><a href="#export_idle_recommendations"><CopyableCode code="export_idle_recommendations" /></a></td>
...
<Tabs
    defaultValue="export_idle_recommendations"
    values={[
        { label: 'export_idle_recommendations', value: 'export_idle_recommendations' }
    ]}
>
<TabItem value="export_idle_recommendations">
