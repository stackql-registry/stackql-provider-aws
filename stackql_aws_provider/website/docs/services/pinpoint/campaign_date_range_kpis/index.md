--- 
title: campaign_date_range_kpis
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>campaign_date_range_kpis</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="campaign_date_range_kpis" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.pinpoint.campaign_date_range_kpis" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_campaign_date_range_kpi"
    values={[
        { label: 'get_campaign_date_range_kpi', value: 'get_campaign_date_range_kpi' }
    ]}
>
<TabItem value="get_campaign_date_range_kpi">
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The unique identifier for the campaign that the metric applies to.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The string to use in a subsequent request to get the next page of results in a paginated response. This value is null for the Campaign Metrics resource because the resource returns all results in a single page.</td>
</tr>
<tr>
...
<tbody>
<tr>
    <td><a href="#get_campaign_date_range_kpi"><CopyableCode code="get_campaign_date_range_kpi" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-application-id"><code>application-id</code></a>, <a href="#parameter-campaign-id"><code>campaign-id</code></a>, <a href="#parameter-kpi-name"><code>kpi-name</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    ...
    <td>Retrieves (queries) pre-aggregated data for a standard metric that applies to a campaign.</td>
</tr>
</tbody>
</table>
