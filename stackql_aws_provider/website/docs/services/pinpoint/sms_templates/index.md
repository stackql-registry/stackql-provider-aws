...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="sms_templates" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.pinpoint.sms_templates" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieves the content and settings of a message template for messages that are sent through the SMS channel.</td>
</tr>
<tr>
    <td><a href="#create_sms_template"><CopyableCode code="create_sms_template" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-template-name"><code>template-name</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-SMSTemplateRequest"><code>SMSTemplateRequest</code></a></td>
    <td></td>
    <td>Creates a message template for messages that are sent through the SMS channel.</td>
</tr>
<tr>
    ...
    <td>Updates an existing message template for messages that are sent through the SMS channel.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-template-name"><code>template-name</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-version"><code>version</code></a></td>
    <td>Deletes a message template for messages that were sent through the SMS channel.</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO aws.pinpoint.sms_templates (
SMSTemplateRequest,
`template-name`,
region
)
...
```sql
UPDATE aws.pinpoint.sms_templates
SET 
SMSTemplateRequest = '{{ SMSTemplateRequest }}'
WHERE 
`template-name` = '{{ template-name }}' --required
AND region = '{{ region }}' --required
AND SMSTemplateRequest = '{{ SMSTemplateRequest }}' --required
...
```sql
DELETE FROM aws.pinpoint.sms_templates
WHERE `template-name` = '{{ template-name }}' --required
AND region = '{{ region }}' --required
AND version = '{{ version }}'
;
