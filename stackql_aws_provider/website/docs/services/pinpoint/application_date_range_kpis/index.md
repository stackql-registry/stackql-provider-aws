--- 
title: application_date_range_kpis
hide_title: false
hide_table_of_contents: false
keywords:
  - application_date_range_kpis
  - pinpoint
  - aws
...
Creates, updates, deletes, gets or lists an <code>application_date_range_kpis</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="application_date_range_kpis" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.pinpoint.application_date_range_kpis" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_application_date_range_kpi"
    values={[
        { label: 'get_application_date_range_kpi', value: 'get_application_date_range_kpi' }
    ]}
>
<TabItem value="get_application_date_range_kpi">
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The string to use in a subsequent request to get the next page of results in a paginated response. This value is null for the Application Metrics resource because the resource returns all results in a single page.</td>
</tr>
<tr>
...
<tbody>
<tr>
    <td><a href="#get_application_date_range_kpi"><CopyableCode code="get_application_date_range_kpi" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-application-id"><code>application-id</code></a>, <a href="#parameter-kpi-name"><code>kpi-name</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    ...
    <td>Retrieves (queries) pre-aggregated data for a standard metric that applies to an application.</td>
</tr>
</tbody>
</table>
...
next_token,
start_time
FROM aws.pinpoint.application_date_range_kpis
