...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.iot_managed_integrations.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>A set of key/value pairs that are used to manage the resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Removes tags from a specified resource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_arn"><code>resource_arn</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Adds tags to a specified resource.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) of the resource to which to add tags.</td>
</tr>
...
SELECT
tags
FROM aws.iot_managed_integrations.tags
...
```sql
UPDATE aws.iot_managed_integrations.tags
SET 
