...
Creates, updates, deletes, gets or lists a <code>restore_job_summaries</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="restore_job_summaries" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.backup.restore_job_summaries" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_restore_job_summaries"
    values={[
        { label: 'list_restore_job_summaries', value: 'list_restore_job_summaries' }
    ]}
>
<TabItem value="list_restore_job_summaries">
...
<tr>
    <td><CopyableCode code="restore_job_summaries" /></td>
    <td><code>array</code></td>
    <td>This return contains a summary that contains Region, Account, State, ResourceType, MessageCategory, StartTime, EndTime, and Count of included jobs.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tbody>
<tr>
    <td><a href="#list_restore_job_summaries"><CopyableCode code="list_restore_job_summaries" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-AccountId"><code>AccountId</code></a>, <a href="#parameter-State"><code>State</code></a>, <a href="#parameter-ResourceType"><code>ResourceType</code></a>, <a href="#parameter-AggregationPeriod"><code>AggregationPeriod</code></a>, <a href="#parameter-MaxResults"><code>MaxResults</code></a>, <a href="#parameter-NextToken"><code>NextToken</code></a></td>
    <td>This request obtains a summary of restore jobs created or running within the the most recent 30 days. You can include parameters AccountID, State, ResourceType, AggregationPeriod, MaxResults, or NextToken to filter results. This request returns a summary that contains Region, Account, State, RestourceType, MessageCategory, StartTime, EndTime, and Count of included jobs.</td>
</tr>
</tbody>
</table>
...
next_token,
restore_job_summaries
FROM aws.backup.restore_job_summaries
