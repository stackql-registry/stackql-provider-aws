--- 
title: directory_data_accesses
hide_title: false
hide_table_of_contents: false
keywords:
  - directory_data_accesses
  - ds
  - aws
...
Creates, updates, deletes, gets or lists a <code>directory_data_accesses</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="directory_data_accesses" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.ds.directory_data_accesses" /></td></tr>
</tbody></table>
...
SELECT
data_access_status
FROM aws.ds.directory_data_accesses
...
```sql
EXEC aws.ds.directory_data_accesses.disable_directory_data_access 
...
```sql
EXEC aws.ds.directory_data_accesses.enable_directory_data_access 
@region='{{ region }}' --required 
@@json=
'{
"DirectoryId": "{{ DirectoryId }}"
