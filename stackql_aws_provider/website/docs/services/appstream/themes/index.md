...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.appstream.themes" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO aws.appstream.themes (
StackName,
FooterLinks,
TitleText,
ThemeStyling,
...
```sql
DELETE FROM aws.appstream.themes
WHERE region = '{{ region }}' --required
;
```
</TabItem>
