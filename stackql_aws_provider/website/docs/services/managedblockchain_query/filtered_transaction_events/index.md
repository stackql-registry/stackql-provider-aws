--- 
title: filtered_transaction_events
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>filtered_transaction_events</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="filtered_transaction_events" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.managedblockchain_query.filtered_transaction_events" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_filtered_transaction_events"
    values={[
        { label: 'list_filtered_transaction_events', value: 'list_filtered_transaction_events' }
    ]}
>
<TabItem value="list_filtered_transaction_events">
...
<tbody>
<tr>
    <td><a href="#list_filtered_transaction_events"><CopyableCode code="list_filtered_transaction_events" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Lists all the transaction events for an address on the blockchain. This operation is only supported on the Bitcoin networks.</td>
</tr>
</tbody>
</table>
