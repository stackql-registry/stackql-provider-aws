...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.appconfig.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Metadata to assign to AppConfig resources. Tags help organize and categorize your AppConfig resources. Each tag consists of a key and an optional value, both of which you define.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Retrieves the list of key-value tags assigned to the resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Deletes a tag key and value from an AppConfig resource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_arn"><code>resource_arn</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Assigns metadata to an AppConfig resource. Tags help organize and categorize your AppConfig resources. Each tag consists of a key and an optional value, both of which you define. You can specify a maximum of 50 tags for a resource.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The ARN of the resource for which to retrieve tags.</td>
</tr>
