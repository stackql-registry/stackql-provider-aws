...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.sesv2.blacklist_reports" /></td></tr>
</tbody></table>
...
<tr id="parameter-BlacklistItemNames">
    ...
    <td>A list of IP addresses that you want to retrieve blacklist information about. You can only specify the dedicated IP addresses that you use to send email using Amazon SES or Amazon Pinpoint.</td>
</tr>
