...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.pinpoint_sms_voice_v2.voice_messages" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Allows you to send a request that sends a voice message. This operation uses Amazon Polly to convert a text script into a voice message.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC aws.pinpoint_sms_voice_v2.voice_messages.send_voice_message 
