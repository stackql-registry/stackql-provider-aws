...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.route53_recovery_control_config.tags" /></td></tr>
</tbody></table>
...
<tr id="parameter-TagKeys">
    ...
    <td>Keys for the tags to be removed.</td>
</tr>
...
<tr id="parameter-resource_arn">
    ...
    <td><code>string</code></td>
    <td>The Amazon Resource Name (ARN) for the resource that's tagged.</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.route53_recovery_control_config.tags
...
```sql
UPDATE aws.route53_recovery_control_config.tags
SET 
