...
Creates, updates, deletes, gets or lists an <code>autoshift_observer_notification_statuses</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="autoshift_observer_notification_statuses" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.arc_zonal_shift.autoshift_observer_notification_statuses" /></td></tr>
</tbody></table>
...
SELECT
status
FROM aws.arc_zonal_shift.autoshift_observer_notification_statuses
...
```sql
UPDATE aws.arc_zonal_shift.autoshift_observer_notification_statuses
SET 
status = '{{ status }}'
WHERE 
