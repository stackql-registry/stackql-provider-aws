...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.efs.file_system_policies" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="describe_file_system_policy"
    values={[
        { label: 'describe_file_system_policy', value: 'describe_file_system_policy' }
    ]}
>
<TabItem value="describe_file_system_policy">
...
<tbody>
<tr>
    <td><a href="#describe_file_system_policy"><CopyableCode code="describe_file_system_policy" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-file_system_id"><code>file_system_id</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Returns the FileSystemPolicy for the specified EFS file system. This operation requires permissions for the elasticfilesystem:DescribeFileSystemPolicy action.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-file_system_id"><code>file_system_id</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Applies an Amazon EFS FileSystemPolicy to an Amazon EFS file system. A file system policy is an IAM resource-based policy and can contain multiple policy statements. A file system always has exactly one file system policy, which can be the default policy or an explicit policy set or updated using this API operation. EFS file system policies have a 20,000 character limit. When an explicit policy is set, it overrides the default policy. For more information about the default file system policy, see Default EFS file system policy. EFS file system policies have a 20,000 character limit. This operation requires permissions for the elasticfilesystem:PutFileSystemPolicy action.</td>
</tr>
<tr>
...
<tr id="parameter-file_system_id">
    ...
    <td><code>string</code></td>
    <td>Specifies the EFS file system for which to delete the FileSystemPolicy.</td>
</tr>
