...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.connectcampaignsv2.tags" /></td></tr>
</tbody></table>
...
SELECT
tags
FROM aws.connectcampaignsv2.tags
...
```sql
UPDATE aws.connectcampaignsv2.tags
SET 
tags = '{{ tags }}'
WHERE 
arn = '{{ arn }}' --required
