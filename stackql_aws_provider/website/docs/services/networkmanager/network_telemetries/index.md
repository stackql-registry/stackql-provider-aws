...
Creates, updates, deletes, gets or lists a <code>network_telemetries</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="network_telemetries" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.networkmanager.network_telemetries" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_network_telemetry"
    values={[
        { label: 'get_network_telemetry', value: 'get_network_telemetry' }
    ]}
>
<TabItem value="get_network_telemetry">
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The address. (pattern: &lt;code&gt;&#91;\s\S&#93;*&lt;/code&gt;)</td>
</tr>
<tr>
...
<tbody>
<tr>
    <td><a href="#get_network_telemetry"><CopyableCode code="get_network_telemetry" /></a></td>
    ...
    <td>Gets the network telemetry of the specified global network.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resourceType">
    <td><CopyableCode code="resourceType" /></td>
    <td><code>string</code></td>
    <td>The resource type. The following are the supported resource types: connect-peer transit-gateway-connect-peer vpn-connection</td>
</tr>
</tbody>
</table>
...
ResourceId,
ResourceType
FROM aws.networkmanager.network_telemetries
