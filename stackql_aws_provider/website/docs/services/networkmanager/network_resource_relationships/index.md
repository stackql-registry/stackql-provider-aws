--- 
title: network_resource_relationships
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>network_resource_relationships</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="network_resource_relationships" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="aws.networkmanager.network_resource_relationships" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_network_resource_relationships"
    values={[
        { label: 'get_network_resource_relationships', value: 'get_network_resource_relationships' }
    ]}
>
<TabItem value="get_network_resource_relationships">
...
<tbody>
<tr>
    <td><a href="#get_network_resource_relationships"><CopyableCode code="get_network_resource_relationships" /></a></td>
    ...
    <td>Gets the network resource relationships for the specified global network.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-registeredGatewayArn">
    ...
    <td><code>string</code></td>
    <td>The ARN of the registered gateway.</td>
</tr>
