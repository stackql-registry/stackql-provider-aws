...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.networkmanager.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Tags a specified resource.</td>
</tr>
<tr>
...
<tr id="parameter-tagKeys">
    ...
    <td><code>array</code></td>
    <td>The tag keys to remove from the specified resource.</td>
</tr>
</tbody>
</table>
...
```sql
UPDATE aws.networkmanager.tags
SET 
Tags = '{{ Tags }}'
WHERE 
