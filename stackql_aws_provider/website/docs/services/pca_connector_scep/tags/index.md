...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.pca_connector_scep.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Removes one or more tags from your resource.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-resource_arn"><code>resource_arn</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Adds one or more tags to your resource.</td>
</tr>
</tbody>
</table>
...
SELECT
Tags
FROM aws.pca_connector_scep.tags
...
```sql
UPDATE aws.pca_connector_scep.tags
SET 
