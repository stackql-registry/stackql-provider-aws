...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.textract.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>A set of tags (key-value pairs) that are part of the requested resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Lists all tags for an Amazon Textract resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Removes any tags with the specified keys from the specified resource.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Adds one or more tags to the specified resource.</td>
</tr>
</tbody>
</table>
