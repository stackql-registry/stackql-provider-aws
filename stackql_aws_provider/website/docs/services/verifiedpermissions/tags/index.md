...
<tr><td><b>Id</b></td><td><CopyableCode code="aws.verifiedpermissions.tags" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The list of tags associated with the resource.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Returns the tags associated with the specified Amazon Verified Permissions resource. In Verified Permissions, policy stores can be tagged.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Removes one or more tags from the specified Amazon Verified Permissions resource. In Verified Permissions, policy stores can be tagged.</td>
</tr>
</tbody>
</table>
...
SELECT
tags
FROM aws.verifiedpermissions.tags
...
```sql
UPDATE aws.verifiedpermissions.tags
SET 
